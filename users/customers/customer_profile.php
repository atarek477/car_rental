...
<body>
    ...
    <div class="container card col-6 mt-4 d-flex align-items-center">
        <div class="flex">
            ...
            <label id="firstName" class = "ms-4"><?=$user["fname"]?></label>
        </div>
        <div class="flex">
            <label class ="fb">Last name:</label>
            <label id = "lastName" class ="ms-4"><?=$user["lname"]?></label>
        </div>
        <div class="flex">
        ...
        <div class="flex">
            <label class ="fb">License:</label>
            <label id = "license"><?=$user["driver_license"]?> </label>
        </div>
        <div class="flex">
            <label class ="fb">Phone number:</label>
            <label id = "phoNo"><?=$user["phonenumber"]?> </label>
        </div>
        <div class="flex">
            <label class ="fb">Country:</label>
            <label id = "country"><?=$user["country"]?> </label>
        </div>
        <div class="flex">
            <label class ="fb">City:</label>
            <label id = "city"><?=$user["city"]?> </label>
        </div>
